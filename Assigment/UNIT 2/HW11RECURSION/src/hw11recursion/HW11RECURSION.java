...
public class HW11RECURSION {
        ...
        do {
            ...
            switch (option) {
                ...
                case 2:
                    ...
                    switch (option3) {
                        case 1:
                            ...
                            degreesTLatitude = ShowTransformGrades(degreesLatitude, minutesLatitude, secondsLatitude, Character.toUpperCase(directionLatitude));
                            transformGrades = ShowTransformGrades(degreesLongitude, minutesLongitude, secondsLongitude, Character.toUpperCase(directionLongitude));

                            degreesTLatitude = ShowRadians(degreesTLatitude);
                            degreesLongitude = ShowRadians(degreesLongitude);

                            ShowConvertions(degreesTLatitude, degreesLongitude);
                        ...
                        case 3:
                            ...
                            System.out.println();
                            double result = ShowDistanceBetweenTwoPointsHaversine(longitude1, latitude1, longitude2, latitude2);
                        ...
                        case 4:
                            ...
                            System.out.println();
                            double dist = CalculeVincentydistance(lat2, lat1, lng2, lng1, earthRadius);
                ...
                case 3:
                    ...
                    IndicateConvertionTemperature(scanner);
                    break;
                case 4:
                    System.out.println("IT HAS BEEN A PLEASURE TO HELP YOU ( ＾◡＾)"
                            + "COME BACK SOON...");
	...
	public static float ShowTransformGrades(float degrees, float minutes, float seconds, char direction) {
    ...
    public static float ShowRadians(float degrees) {
    ...
    public static int ShowDistanceBetweenTwoPointsHaversine(double longitude1,
    ...
    private static double CalculeVincentydistance(double lat2, double lat1, double lng2, double lng1, double earthRadius) {
    ...
    private static void IndicateConvertionTemperature(Scanner scanner) {
        double f;
        double c;
        double k;
